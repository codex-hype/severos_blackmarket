    ...
    <section id="backgrounds">
        <div id="wrapper">
            <div id="header-content-container">
                <h1 id="header-h1">Arsenal</h1>
                <p class="caption">This arsenal defines you, Every weapon whispers your lethal intent.</p>
            </div>
            <div id="search-container"> <input type="search" name="search" id="search" placeholder="Search weapons..">
                <div class="divider divider-horizontal"></div>
            </div>
        </div>
        <form action="arsenal.php" method="post" id="purchase-form"> <input type="hidden" name="selected_gun"
        ...
        <div class="filtercontainer">
            <h1>Filters</h1>
            <p class="caption" style="font-weight: bold; margin-top: 10px; margin-bottom: 5px;">Weapon Type</p>
            <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 15px;"> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-type" value="handgun"> Handgun </label> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-type" value="assault rifle"> Assault Rifle </label> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-type" value="machine gun"> Machine Gun </label> </div>
            <p class="caption" style="font-weight: bold; margin-bottom: 5px;">Rarity</p>
            <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 20px;"> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-rarity" value="common"> Common </label> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-rarity" value="rare"> Rare </label> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-rarity" value="epic"> Epic </label> <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer;"> <input type="checkbox"
                        class="filter-rarity" value="legendary"> Legendary </label> </div> <button type="button"
                id="apply-filters-btn"
                style="width: 100%; padding: 10px; background-color: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;">Apply
                Filters</button>
        </div>
