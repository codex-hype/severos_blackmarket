...
<body>
    ...
    <section id="backgrounds">
        ...
        <form action="arsenal.php" method="post" id="purchase-form">
            ...
            <div class="containercard">
                <?php foreach ($array as $item):
                    ...
                    ?>
                    <div class="carditem" data-source="arsenal" data-gun="<?= htmlspecialchars($item['gun']) ?>"
        ...
        <div class="filtercontainer">
            ...
            <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 15px;">
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-type" value="handgun"> Handgun
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-type" value="assault rifle"> Assault Rifle
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-type" value="machine gun"> Machine Gun
                </label>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 20px;">
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-rarity" value="common"> Common
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-rarity" value="rare"> Rare
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-rarity" value="epic"> Epic
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    <input type="checkbox" class="filter-rarity" value="legendary"> Legendary
                </label>
            </div>
